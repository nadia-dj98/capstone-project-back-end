...
public class DataLoader implements ApplicationRunner {
    ...
    public  void run(ApplicationArguments args) throws Exception{
        ...
        Job uxDesigner = new Job("UX Designer", "We're seeking a talented individual to join our team on a short project creating a new feature for our website", LocalDate.of(2023, 03, 25), LocalDate.of(2023, 04, 30),"remote");
        Job frontEndDeveloper = new Job("Front-end Developer", "We're seeking a talented individual to revamp our website", LocalDate.of(2023, 04, 01), LocalDate.of(2023, 05, 30),"london");
        Job backEndDeveloper = new Job("Back-end Developer", "We're seeking a talented individual to help us ", LocalDate.of(2023, 03, 25), LocalDate.of(2023, 04, 30),"Essex");
        Job productManager = new Job("Product Manager", "We're seeking a talented individual to join our team to help us refine our mvp", LocalDate.of(2023, 05, 25), LocalDate.of(2023, 06, 30),"Halifax");
